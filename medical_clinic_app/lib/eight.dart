...
List<String> Names=["Dr.Floyd Miles"];
List<String> pes=["Pediatrics"];
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Spacer(),
                        Text("See all",style: GoogleFonts.lato(fontSize: 12.sp,fontWeight: FontWeight.w400,color: Color(0xff1C1F1E)),),
                      ],
                    ),
                                  ...
                                  Container(
                                    child: Row(
                                      children: [
                                        ...
                                        Text(
                                          currenttime.day.toString()+"-"+monthName!,
                                          style: GoogleFonts.lato(
                                              fontSize: 14.sp,
                                              fontWeight: FontWeight.w500,
                                              color: Color(0xffFFFFFF)),
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return      GestureDetector(
                      onTap: (){
                       bottomState.screenController.add(doctorview2(name: Names[index],pes: pes[index],));
